                ...
                try
                {
                    ...
                    switch (cmd)
                    {
                        ...
                        case -9: //light source..
                            ...
                            buf = fp.ReadLine();
                            item.Attenuation = int.Parse(buf);
                        ...
                        case 11:  //dynamic model
                            ...
                            if (parsed[0] == "1")
                                ...
                                dm.Collision = false;
                            dm.TriggerType = int.Parse(parsed[1]);
                            dm.ActiveRadius = double.Parse(parsed[2]);
                            dm.TriggerAction = int.Parse(parsed[3]);
                            ...
                            dm.HighlightStyle = int.Parse(parsed[1]);
